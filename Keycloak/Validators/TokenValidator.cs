...
using System.Text;
//There's definitely better ways of doing this.  I believe there are .NET packages for JWT validation.  This is largely an exercise in working with JWTs manually.
namespace Keycloak
{
